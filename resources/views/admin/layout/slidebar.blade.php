...
<aside class="app-sidebar">
      ...
      <ul class="app-menu">
            ...
            <li><a class="app-menu__item" href="?act=quanlynhanvien"><i class='app-menu__icon bx bx-id-card'></i> <span class="app-menu__label">Quản lý loại phòng</span></a></li>
            <li><a class="app-menu__item" href="?act=quanlykhachhang"><i class='app-menu__icon bx bx-user-voice'></i><span class="app-menu__label">Quản lý phòng</span></a></li>
            ...
            <li><a class="app-menu__item" href="?act=quanlydanhmuc"><i class='app-menu__icon bx bx-purchase-tag-alt'></i><span class="app-menu__label">Quản lý khách hàng</span></a>
            </li>
            <li><a class="app-menu__item" href="?act=quanlysanpham"><i class='app-menu__icon bx bx-purchase-tag-alt'></i><span class="app-menu__label">Đánh giá</span></a>
            </li>
